...
dz = 5   # base cell width in x, y and z
...
maxval =target_magnetization_amplitude+40
fig, ax = plt.subplots(1, 2, figsize=(17, 5), gridspec_kw={'width_ratios': [2, 1]})
...
plot_vector_model(maxval,mrec_cartesian, ax=ax[1], normal="Z", ind=5)
ax[0].set_title(f"y={mesh.vectorCCy[30]}")
ax[1].set_title(f"z={mesh.vectorCCz[5]}")
...
plot_vector_model(maxval,mrec_cartesian, ax=ax[0,1], normal="Z", ind=10)
plot_vector_model(maxval,mrec_cartesian, ax=ax[0,2], normal="Z", ind=9)
plot_vector_model(maxval,mrec_cartesian, ax=ax[1,0], normal="Z", ind=8)
plot_vector_model(maxval,mrec_cartesian, ax=ax[1,1], normal="Z", ind=7)
plot_vector_model(maxval,mrec_cartesian, ax=ax[1,2], normal="Z", ind=6)
plot_vector_model(maxval,mrec_cartesian, ax=ax[2,0], normal="Z", ind=5)
plot_vector_model(maxval,mrec_cartesian, ax=ax[2,1], normal="Z", ind=4)
plot_vector_model(maxval,mrec_cartesian, ax=ax[2,2], normal="Z", ind=3)

ax[0,0].set_title(f"y={mesh.vectorCCy[30]}")
ax[0,1].set_title(f"z={mesh.vectorCCz[10]}")
ax[0,2].set_title(f"z={mesh.vectorCCz[9]}")
ax[1,0].set_title(f"z={mesh.vectorCCz[8]}")
ax[1,1].set_title(f"z={mesh.vectorCCz[7]}")
ax[1,2].set_title(f"z={mesh.vectorCCz[6]}")
ax[2,0].set_title(f"z={mesh.vectorCCz[5]}")
ax[2,1].set_title(f"z={mesh.vectorCCz[4]}")
...
# create the regularization
reg_amplitude = regularization.Sparse(mesh, indActive=actv, mapping=wires.amplitude, alpha_z=1e-6)#, alpha_z=1e-8)
...
plot_vector_model(maxval,m, ax=ax[0,1], normal="Z", ind=10)
plot_vector_model(maxval,m, ax=ax[0,2], normal="Z", ind=9)
plot_vector_model(maxval,m, ax=ax[1,0], normal="Z", ind=8)
plot_vector_model(maxval,m, ax=ax[1,1], normal="Z", ind=7)
plot_vector_model(maxval,m, ax=ax[1,2], normal="Z", ind=6)
plot_vector_model(maxval,m, ax=ax[2,0], normal="Z", ind=5)
plot_vector_model(maxval,m, ax=ax[2,1], normal="Z", ind=4)
plot_vector_model(maxval,m, ax=ax[2,2], normal="Z", ind=3)
