...
if gauss_noise > 0:  #inflight measuremenets 
    ...
    mag_f[ind2, :] = target_magnetization-5
    mag_f[ind3, :] = target_magnetization+10
    model_f = mag_f[actv, :]

magnetization[ind1, :] = target_magnetization
magnetization[ind2, :] = target_magnetization-5
magnetization[ind3, :] = target_magnetization+10
